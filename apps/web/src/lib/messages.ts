export const messages = {
  en: {
    ...
    diningDetail: 'Manage table orders',
    kitchenQueue: 'Kitchen queue',
    kitchenDetail: 'View live tickets',
    ...
    viewAll: 'View all',
    noRecentActivity: 'No orders yet today.',
    preparing: 'Preparing',
    ready: 'Ready',
    paid: 'Paid',
    language: 'Language',
    ...
    noStockItems: 'No stock items yet. Add one above.',
    ...
    settingsDataReset: 'Branch settings were reset to defaults.',
    shiftDataReset: 'Shift data was reset - the current shift may be wrong.',
    categorySaved: 'Category saved.',
    categoryRemoved: 'Category removed.',
    menuItemSaved: 'Menu item saved.',
    menuItemRemoved: 'Menu item removed.',
    itemAvailabilityUpdated: 'Availability updated.',
  ...
  th: {
    ...
    syncPending: 'รอซิงก์',
    hubUptime: 'เวลาทำงาน',
    hubCheckedAt: 'ตรวจสอบล่าสุด',
    hubLastError: 'ข้อผิดพลาดล่าสุด',
    ...
    diningDetail: 'จัดการออเดอร์โต๊ะ',
    kitchenQueue: 'คิวครัว',
    kitchenDetail: 'ดูคิวครัวแบบเรียลไทม์',
    ...
    viewAll: 'ดูทั้งหมด',
    noRecentActivity: 'ยังไม่มีออเดอร์วันนี้',
    ...
    noStockItems: 'ยังไม่มีรายการสต็อก เพิ่มรายการด้านบน',
    ...
    activeTickets: 'รายการที่ค้างอยู่',
    queued: 'รอทำ',
    completed: 'เสร็จสิ้น',
    ...
    settingsDataReset: 'ตั้งค่าสาขากลับเป็นค่าเริ่มต้นแล้ว',
    shiftDataReset: 'รีเซ็ตข้อมูลกะแล้ว กะปัจจุบันที่แสดงอาจไม่ถูกต้อง',
    ...
    itemAvailabilityUpdated: 'อัปเดตสถานะพร้อมขายแล้ว',
